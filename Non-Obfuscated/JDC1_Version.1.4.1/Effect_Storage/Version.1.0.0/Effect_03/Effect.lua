...
while wait() do
	for i,v in pairs(Fixtures) do
		for i,x in pairs(v.Head.Lens:GetChildren()) do
			if x.Name == "L1" or x.Name == "L3" or x.Name == "L5" or x.Name == "L8" or x.Name == "L10" or x.Name == "L12" then
				spawn(function()
					for i = 0, 1, .1 do
						x.Transparency = i
						wait(y.Value)
	...
	for i,v in pairs(Fixtures) do
		for i,x in pairs(v.Head.Lens:GetChildren()) do
			if x.Name == "L2" or x.Name == "L4" or x.Name == "L6" or x.Name == "L7" or x.Name == "L9" or x.Name == "L11" then
				spawn(function()
					for i = 0, 1, .1 do
						x.Transparency = i
						wait(y.Value)
